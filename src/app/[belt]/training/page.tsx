        ...
        <div className="mx-auto max-w-4xl space-y-4 md:space-y-6">
          <nav className="px-1 text-sm">
            <div className="flex flex-wrap items-center gap-6" style={{ color: "var(--nav-text)" }}>
              <Link href="/white-to-blue" className="font-semibold text-blue-700 underline underline-offset-4">
                White to Blue
              </Link>
              <Link href="/blue-to-purple" className="font-semibold text-blue-700 hover:underline">
                Blue to Purple
              </Link>
          ...
          >
            <h1 className="text-4xl font-bold leading-tight text-blue-700 md:text-6xl">Test Preparation Guide</h1>
          ...
          >
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <a
                className="inline-flex h-8 items-center rounded-full border px-3 text-sm hover:bg-slate-50"
          ...
          <article
            ...
            style={{ borderColor: "var(--border-1)", backgroundColor: "var(--surface-1)" }}
          >
            <h2 className="text-4xl font-bold text-slate-900 md:text-5xl">Overview</h2>
            ...
            <h3 className="mt-6 text-2xl font-semibold text-slate-900">Common Mistakes</h3>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-base text-slate-700 marker:text-blue-600">
              <li>Rushing through techniques</li>
              <li>Skipping key positional moments</li>
            </ul>

            <h3 className="mt-6 text-2xl font-semibold text-slate-900">Training Structure</h3>
            ...
            <h3 className="mt-6 text-2xl font-semibold text-slate-900">Session Flow</h3>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-base text-slate-700 marker:text-blue-600">
            ...
            <div className="mt-5 rounded-lg border-l-4 bg-blue-50 p-4 text-base text-slate-700" style={{ borderLeftColor: "#2563eb" }}>
            ...
            <h3 className="mt-6 text-2xl font-semibold text-slate-900">What to Write Down</h3>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-base text-slate-700 marker:text-blue-600">
            ...
            <h3 className="mt-6 text-2xl font-semibold text-slate-900">How to Ask Better Questions</h3>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-base text-slate-700 marker:text-blue-600">
          ...
          <article
            ...
            style={{ borderColor: "var(--border-1)", backgroundColor: "var(--surface-1)" }}
          >
            <h2 className="text-4xl font-bold text-slate-900 md:text-5xl">30-Day Plan</h2>
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              {whiteToBlueThirtyDayPlan.map((phase) => (
                ...
                >
                  <h3 className="text-xl font-semibold text-slate-900">{phase.week}</h3>
                  <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-slate-700 marker:text-blue-600">
          ...
          <article
            ...
            style={{ borderColor: "var(--border-1)", backgroundColor: "var(--surface-1)" }}
          >
            <h2 className="text-4xl font-bold text-slate-900 md:text-5xl">Shark Tank Strategy</h2>
            <p className="mt-4 text-base leading-8 text-slate-700">
            ...
            <div className="mt-4 rounded-lg border-l-4 bg-blue-50 p-4 text-base text-slate-700" style={{ borderLeftColor: "#2563eb" }}>
              <strong>You do not get a medal for not tapping.</strong>
            </div>
            <h3 className="mt-6 text-2xl font-semibold text-slate-900">Priorities</h3>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-base text-slate-700 marker:text-blue-600">
              <li>Frames first</li>
        ...
        <div className="mx-auto max-w-4xl space-y-4 md:space-y-6">
          <nav className="px-1 text-sm">
            <div className="flex flex-wrap items-center gap-6" style={{ color: "var(--nav-text)" }}>
              ...
              <Link href="/blue-to-purple" className="font-semibold text-purple-700 underline underline-offset-4">
                Blue to Purple
              </Link>
              <Link href="/purple-to-brown" className="font-medium text-[var(--foreground)] hover:underline">
                Purple to Brown
          ...
          >
            <h1 className="text-4xl font-bold leading-tight text-purple-700 md:text-6xl">Test Preparation Guide</h1>
            <p className="mt-3 max-w-3xl text-base leading-8 text-slate-700">
              Congratulations, you got <strong>&ldquo;the email&rdquo;</strong> (or your instructor told you)
          ...
          >
            ...
            <p className="mt-4 text-base leading-8 text-slate-700">This test asks:</p>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-base text-slate-700 marker:text-purple-600">
          ...
          <article
            ...
            style={{ borderColor: "var(--border-1)", backgroundColor: "var(--surface-1)" }}
          >
            <h2 className="text-4xl font-bold text-slate-900 md:text-5xl">Technique Portion</h2>
            <p className="mt-4 text-base leading-8 text-slate-700">
          ...
          <article
            ...
            style={{ borderColor: "var(--border-1)", backgroundColor: "var(--surface-1)" }}
          >
            <h2 className="text-4xl font-bold text-slate-900 md:text-5xl">Show Your Game</h2>
            <p className="mt-4 text-base leading-8 text-slate-700">
            ...
            <p className="mt-4 text-base leading-8 text-slate-700">For every position, define:</p>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-base text-slate-700 marker:text-purple-600">
            ...
            <div className="mt-5 rounded-lg border-l-4 bg-purple-50 p-4 text-base text-slate-700" style={{ borderLeftColor: "#7c3aed" }}>
              This creates decision trees. <strong>You are not improvising.</strong> You are executing a system.
            </div>

            <h3 className="mt-6 text-2xl font-semibold text-slate-900">Example Structure</h3>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <section
                className="rounded-xl border p-4"
                style={{ borderColor: "var(--border-1)", backgroundColor: "var(--panel-soft)" }}
              >
                <h4 className="text-lg font-semibold text-slate-900">Closed Guard</h4>
                <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-slate-700 marker:text-purple-600">
              ...
              <section
                ...
                style={{ borderColor: "var(--border-1)", backgroundColor: "var(--panel-soft)" }}
              >
                <h4 className="text-lg font-semibold text-slate-900">Cross Body</h4>
                <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-slate-700 marker:text-purple-600">
            ...
            <h3 className="mt-6 text-2xl font-semibold text-slate-900">How to Train Show Your Game</h3>
            <p className="mt-3 text-base leading-8 text-slate-700">Twice per week (open mat helps):</p>
            <ul className="mt-2 list-disc space-y-2 pl-5 text-base text-slate-700 marker:text-purple-600">
          ...
          >
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              {blueToPurpleThirtyDayPlan.map((phase) => (
                ...
                >
                  <h3 className="text-xl font-semibold text-slate-900">{phase.week}</h3>
                  <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-slate-700 marker:text-purple-600">
                    {phase.items.map((item) => (
                      <li key={item}>{item}</li>
                    ))}
                  </ul>
          ...
          >
            ...
            <div className="mt-4 rounded-lg border-l-4 bg-purple-50 p-4 text-base text-slate-700" style={{ borderLeftColor: "#7c3aed" }}>
