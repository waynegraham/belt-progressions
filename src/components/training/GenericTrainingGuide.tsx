...
export default function GenericTrainingGuide({
  track,
  title,
  primaryTheme,
}: GenericTrainingGuideProps) {
  return (
    <TrainingPageFrame
    ...
    >
      ...
      >
        <p className="text-sm font-semibold tracking-wider text-[var(--muted-subtle)] uppercase">
          Preparation
        </p>
        <h1
          className={`mt-1 bg-clip-text text-5xl leading-tight font-extrabold text-transparent md:text-7xl ${primaryTheme.headingGradientClass}`}
        >
